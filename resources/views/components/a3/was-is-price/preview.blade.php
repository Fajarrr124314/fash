                           ...
                           <div class="price-area-a3">
                               ...
                               <div class="flex flex-col items-center justify-center gap-2 my-1">
                                   ...
                                   <div class="flex items-start select-none relative">
                                       <span class="old-price-rp-a3">Rp</span>
                                       <div class="coret-diagonal-preview flex items-start text-[#dc2626] font-bold">
                                           <span class="old-price-base-a3">{{ $oldParts['base'] }}</span>
                                           <span class="old-price-suffix-a3">{{ $oldParts['suffix'] }}</span>
                                       </div>
                                   </div>
                                   <!-- Promo Price Row -->
                                   <div class="flex items-start select-none">
                                       <span class="promo-price-rp-a3">Rp</span>
                                       <div class="flex items-start text-[#dc2626] font-bold">
                                           <span class="promo-price-base-a3">{{ $promoParts['base'] }}</span>
                                           <span class="promo-price-suffix-a3">{{ $promoParts['suffix'] }}</span>
                                       </div>
                                   </div>
                               </div>
                           </div>
